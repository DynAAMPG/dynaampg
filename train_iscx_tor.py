...
if __name__ == "__main__":
    ...
    dataset = SessionDataset(root=dataset, class_labels=iscx_tor_get_unique_labels())
    ...
    for epoch in range(1, epochs+1):
        ...
        if train_acc > max_train_acc:
            torch.save(model.state_dict(), os.path.join(SAVED_MODELS_DIR, "gformer_model_weights_iscx_tor_" + str(epoch) + ".pth"))
