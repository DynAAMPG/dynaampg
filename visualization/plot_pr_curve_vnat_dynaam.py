...
if __name__ == "__main__":   
    batch_size = 32
    hidden_size = 1500
    model_name = 'baseline_classifier_vnat_dynaam_40.pth'
    title = "Precision-Recall Curve (DynAAM) - VNAT"
    file_name = "fig-pr-curves-vnat(dynaam).png"
    ...
    train_loader, test_loader = dataset.get_train_test_loaders(split=0.1)   
    ...
    plot_pr_curves(model, test_loader, num_classes, device, vnat_class_counts, title, file_name)    
