...
from baseline_alt_2 import BaselineAlt2Classifier
from config import *
...
def train_model(model, train_loader, num_epochs=10, learning_rate=0.001):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f'{SAVED_MODELS_DIR}/baseline_classifier_vnat_dynaam_{epoch}.pth')
...
if __name__ == "__main__":
    ...
    train_loader, test_loader = dataset.get_train_test_loaders(split=0.9)    
